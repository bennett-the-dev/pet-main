class PetManager {
    constructor() {
        this.petTypes = {
            common: {
                cat: { name: 'Cat', icon: 'bi bi-cat', basePrice: 5, growthTime: 15, rarity: 'Common' },
                dog: { name: 'Dog', icon: 'bi bi-paw', basePrice: 8, growthTime: 15, rarity: 'Common' },
            ...
            legendary: {
                ...
                ancient: { name: 'Ancient One', icon: 'bi bi-crown', basePrice: 75000, growthTime: 60, rarity: 'Legendary' },
                divine: { name: 'Divine Spirit', icon: 'bi bi-stars', basePrice: 100000, growthTime: 60, rarity: 'Legendary' }
            },
            mythical: {
            ...
            divine: {
                ...
                archangel: { name: 'Archangel', icon: 'bi bi-wing', basePrice: 25000000, growthTime: 105, rarity: 'Divine' },
                cherub: { name: 'Cherub Lord', icon: 'bi bi-person', basePrice: 40000000, growthTime: 105, rarity: 'Divine' },
                throne: { name: 'Throne Bearer', icon: 'bi bi-crown', basePrice: 60000000, growthTime: 105, rarity: 'Divine' },
